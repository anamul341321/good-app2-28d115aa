...
BEGIN
  ...
  -- Referral commission units: every qualifying referee counts as one unit per
  -- completed block of 10 re-verifies (10 -> 1, 20 -> 2, 30 -> 3 ...), minimum 1.
  -- Each unit is worth 10% of the 500 BDT/month base rate.
