...
BEGIN
  ...
  SELECT slot, greatest(coalesce(locked_mined, 0), 0)
    INTO v_slot, v_locked
    FROM public.tasks
...
REVOKE ALL ON FUNCTION public.claim_slot_mining(uuid, uuid) FROM public, anon, authenticated;