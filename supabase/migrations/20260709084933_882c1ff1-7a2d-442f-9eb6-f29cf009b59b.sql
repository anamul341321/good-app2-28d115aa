...
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS bonus_first_verify_claimed boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS bonus_reverify_claimed boolean NOT NULL DEFAULT false;
...
BEGIN
  ...
  -- Only re-verified (done) slots contribute to mining. First-verify (verified)
  -- gives a one-time bonus but does NOT start mining.
