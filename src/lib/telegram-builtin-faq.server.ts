...
export const BUILTIN_FAQS: BuiltinFaq[] = [
  ...
  },
  {
    ...
    answer:
      `এখানে <b>১৮ বছরের বেশি বয়সের ফেস</b> লাগে 🙂 কম বয়সী ফেস দিলে GoodDollar সেটা গ্রহণ করে না।\n\n` +
      `⚠️ খুব গুরুত্বপূর্ণ কথা — <b>কম বয়সী ফেস দিয়ে প্রথমবার ভেরিফিকেশন হয়ে গেলেও রি-ভেরিফাই হবে না</b>। ` +
      `প্রথমবার হয়ে যাওয়া মানেই ফেসটি বৈধ নয়; পরের বার সিস্টেম বয়স যাচাই করে আটকে দেয়।\n\n` +
      `আমাদের মাসিক পেমেন্ট নিতে হলে প্রতি মাসে রি-ভেরিফাই করতেই হবে — তাই <b>আপনি এবং আপনার সাক্ষী দুজনকেই প্রাপ্তবয়স্ক (১৮+) ও যোগ্য ব্যক্তি</b> হতে হবে।\n\n` +
