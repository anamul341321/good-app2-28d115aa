...
export const BUILTIN_FAQS: BuiltinFaq[] = [
  ...
  },
  {
    ...
    screenshot: ["18", "age", "You must be 18", "under age"],
    keywords: ["18+", "18 plus", "boyos", "বয়স", "age problem", "kid face", "ছোট ফেস"],
    answer:
      `এখানে <b>১৮ বছরের বেশি বয়সের ফেস</b> লাগে। কম বয়সী ফেস দিলে ভেরিফিকেশন হয় না, আর হলেও পরে রি-ভেরিফাইয়ে সমস্যা করে।\n\n` +
      `👉 বড় কারো ফেস দিয়ে চেষ্টা করুন, মুখে ভালো আলো রাখুন এবং চশমা/টুপি খুলে নিন 🙂`,
  },
  {
