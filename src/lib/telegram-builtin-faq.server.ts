...
export const BUILTIN_FAQS: BuiltinFaq[] = [
...

  {
    ...
    answer:
      ...
      `📲 লিংকে গিয়ে <b>নীচে বড় "Download App" / "অ্যাপ ডাউনলোড করুন"</b> বাটনে চাপলেই APK ফাইল ডাউনলোড হবে। ডাউনলোড শেষে সেটি ওপেন করলেই ইনস্টল হয়ে যাবে ✅\n` +
...

  {
    ...
    answer:
      ...
      `<b>৪️⃣</b> ফোন জিজ্ঞেস করলে <b>"Install unknown apps"</b> / <b>"অজানা সোর্স থেকে ইনস্টল"</b> অনুমতি দিন।\n` +
