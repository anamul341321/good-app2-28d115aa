  ...
  try {
    ...
    if (name === "fee_quote") {
      ...
      if (!Number.isFinite(amount) || amount <= 0) {
        return "নিয়ম: উইথড্র ফি: ১০০৳ এর কম হলে ১৫%, ১০০৳ বা তার বেশি হলে ১০%। সর্বনিম্ন ৬০৳ (ফি ৯৳, হাতে ৫১৳)।";
      }
...
export async function agentAnswer(opts: {
  ...
  const system =
    ...
    `১০০৳ এর কম উইথড্রে ফি ১৫%, ১০০৳ বা তার বেশি হলে ১০%। তাই ১০০৳ → ফি ১০৳ → হাতে ৯০৳, ৬০৳ → ফি ৯৳ → হাতে ৫১৳। এটা কোনো ভুল নয়। ২–৩ লাইনেই বোঝাবে।\n` +
