  ...
  try {
    ...
    if (name === "fee_quote") {
      ...
      if (!Number.isFinite(amount) || amount <= 0) {
        return "নিয়ম: উইথড্র ফি ফিক্সড ১০৳ — যত টাকাই তুলুন ফি ১০৳। সর্বনিম্ন ৬০৳ (হাতে ৫০৳)।";
      }
...
export async function agentAnswer(opts: {
  ...
  const system =
    ...
    `উইথড্র ফি ফিক্সড ১০৳ — যত টাকাই তুলুক ফি ১০৳। তাই ১০০৳ → ফি ১০৳ → হাতে ৯০৳, ৬০৳ → হাতে ৫০৳। এটা কোনো ভুল নয়। ২–৩ লাইনেই বোঝাবে।\n` +
