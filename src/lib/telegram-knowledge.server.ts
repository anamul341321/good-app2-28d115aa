...
export function knowledgeText(r: AppRates): string {
 ...
 3) এরপর ৪ দিন পর প্রতিটি স্লট আবার রি-ভেরিফাই করতে হয়। ১০টি স্লট রি-ভেরিফাই সফলভাবে সম্পন্ন হলে সেখানে '✅ সম্পূর্ণ' লেখা দেখায়। ১০টি স্লট রি-ভেরিফাই সম্পন্ন হলে ইউজার পায় ${tk(re)} এবং তার মাইনিং চালু হয়ে যায়।
...
export function earningGuideReply(name: string, r: AppRates): string {
  ...
  return (
    ...
    `<b>২️⃣ দ্বিতীয় ধাপ:</b> ৪ দিন পর সেই ১০টি স্লট আবার <b>রি-ভেরিফাই</b> করুন → পাবেন <b>${tk(re)}</b> এবং আপনার <b>মাইনিং চালু</b> হয়ে যাবে (সফলভাবে সম্পন্ন হলে সেখানে <b>'✅ সম্পূর্ণ'</b> লেখা দেখাবে) ⛏️\n` +
